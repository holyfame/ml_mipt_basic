...
class Node:
    ...
    """
    def __init__(self, feature_index, threshold, probas=0):
...
class DecisionTree(BaseEstimator):
    ...
    def make_split_only_y(self, feature_index, threshold, X_subset, y_subset):
        ...
        threshold_condition = X_subset[:, feature_index] < threshold
        y_left = y_subset[threshold_condition]
        y_right = y_subset[threshold_condition == False]
    ...
    def choose_best_split(self, X_subset, y_subset):
        ...
        for fi in range(n_features):
          thresholds = np.sort(np.unique(X_subset[:, fi]))
          for t in thresholds:
            y_left, y_right = self.make_split_only_y(fi, t, X_subset, y_subset)
    ...
    def recursive_predict(self, node, X, indices, y_predicted, probas=False):
        if node.left_child is None:
            ...
            (X_left, left_indices), (X_right, right_indices) = self.make_split(node.feature_index, node.value, X, indices)
